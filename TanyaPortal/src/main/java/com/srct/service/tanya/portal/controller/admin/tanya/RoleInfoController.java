...
public class RoleInfoController {
    ...
    public ResponseEntity<CommonResponse<QueryRespVO<RoleInfo>>.Resp> getRoleInfoSelective(
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", dataType = "Integer", name = "id", value = "RoleInfo的主键"),
    ...
    public ResponseEntity<CommonResponse<QueryRespVO<RoleInfo>>.Resp> getRoleInfo(
    ...
    public ResponseEntity<CommonResponse<Integer>.Resp> delRoleInfo(@RequestParam(value = "id") Integer id) {
        RoleInfo roleInfo = new RoleInfo();
        roleInfo.setId(id);
