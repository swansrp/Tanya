...
public class FactoryMerchantMapController {
    ...
    public ResponseEntity<CommonResponse<Integer>.Resp> updateFactoryMerchantMap(
        ...
        Integer id = factoryMerchantMapDao.updateFactoryMerchantMap(factoryMerchantMap).getId();
    ...
    public ResponseEntity<CommonResponse<QueryRespVO<FactoryMerchantMap>>.Resp> getFactoryMerchantMapSelective(
            @RequestBody FactoryMerchantMapEntityVO vo) {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", dataType = "Integer", name = "id", value = "FactoryMerchantMap的主键"),
    ...
    public ResponseEntity<CommonResponse<QueryRespVO<FactoryMerchantMap>>.Resp> getFactoryMerchantMap(
    ...
    public ResponseEntity<CommonResponse<Integer>.Resp> delFactoryMerchantMap(@RequestParam(value = "id") Integer id) {
        FactoryMerchantMap factoryMerchantMap = new FactoryMerchantMap();
        factoryMerchantMap.setId(id);
        factoryMerchantMap.setValid(DataSourceCommonConstant.DATABASE_COMMON_INVALID);
        Integer delId = factoryMerchantMapDao.updateFactoryMerchantMap(factoryMerchantMap).getId();
