...
public class DiscountInfoController {
    ...
    public ResponseEntity<CommonResponse<QueryRespVO<DiscountInfo>>.Resp> getDiscountInfoSelective(
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query", dataType = "Integer", name = "id", value = "DiscountInfo的主键"),
    ...
    public ResponseEntity<CommonResponse<QueryRespVO<DiscountInfo>>.Resp> getDiscountInfo(
    ...
    public ResponseEntity<CommonResponse<Integer>.Resp> delDiscountInfo(@RequestParam(value = "id") Integer id) {
        DiscountInfo discountInfo = new DiscountInfo();
